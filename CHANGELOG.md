...
#### ✨ Новые возможности
- **Переключатель автообновления** - настройка автоматической проверки при запуске
- Автообновление включено по умолчанию
- Можно отключить проверку обновлений при каждом запуске
- Ручная проверка всегда доступна в настройках
